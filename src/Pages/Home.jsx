            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="p-4 space-y-2 text-sm dark:text-gray-600">
                  ...
                  <p>
                    I feel more grounded, more present. A must for anyone
                    seeking mindful transformation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="p-4 space-y-2 text-sm dark:text-gray-600">
                  <p>
                    ...
                    reflective exercises helped me understand my emotions and
              ...
              <div className="flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="p-4 space-y-2 text-sm dark:text-gray-600">
                  <p>
                    ...
                    InnerSelf changed that. The calm wisdom in its content
                    speaks to all generations.
                  </p>
                  <p>
                    I feel like I’m learning to live all over again—slowly,
                    fully, with grace.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800 mr-4">
                ...
                <div className="p-4 space-y-2 text-sm dark:text-gray-600">
                  <p>
                    ...
                    routine. The sleep stories and mindful breathing practices
                    are just magical.
                  </p>
                  <p>
